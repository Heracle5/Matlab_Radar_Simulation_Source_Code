...
% Hints: contents = get(hObject,'String') returns winlist contents as cell planar_array_gui
...
% Hints: contents = get(hObject,'String') returns arraylist contents as cell planar_array_gui
